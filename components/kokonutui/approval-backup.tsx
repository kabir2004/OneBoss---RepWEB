  ...
  const getStatusIcon = (status: string) => {
    switch (status) {
      ...
      case 'signed':
        return <CheckCircle className="h-3 w-3 text-green-600" />
      case 'pending_signature':
        return <PenTool className="h-3 w-3 text-orange-600" />
      case 'expired':
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="group relative overflow-hidden rounded-xl border border-gray-200 bg-gradient-to-br from-blue-50 via-white to-blue-50/30 p-4 transition-all duration-300 hover:shadow-lg hover:shadow-blue-100/50 hover:border-blue-200 hover:-translate-y-0.5">
          ...
          <div className="relative">
            ...
            <div className="text-2xl font-bold text-gray-900 group-hover:text-blue-700 transition-colors duration-300">{totalItems}</div>
            <div className="text-xs text-gray-500 mt-1">Items</div>
          </div>
        </div>

            <div className="group relative overflow-hidden rounded-xl border border-gray-200 bg-gradient-to-br from-amber-50 via-white to-amber-50/30 p-4 transition-all duration-300 hover:shadow-lg hover:shadow-amber-100/50 hover:border-amber-200 hover:-translate-y-0.5">
              <div className="absolute inset-0 bg-gradient-to-br from-amber-500/5 via-transparent to-amber-500/10 opacity-0 group-hover:opacity-100 transition-opacity duration-500"></div>
              <div className="relative">
                <div className="flex items-center gap-2 mb-2">
                ...
                <div className="text-2xl font-bold text-gray-900 group-hover:text-amber-700 transition-colors duration-300">{pendingApprovals}</div>
            ...
            <div className="group relative overflow-hidden rounded-xl border border-gray-200 bg-gradient-to-br from-purple-50 via-white to-purple-50/30 p-4 transition-all duration-300 hover:shadow-lg hover:shadow-purple-100/50 hover:border-purple-200 hover:-translate-y-0.5">
              ...
              <div className="relative">
                ...
                <div className="text-2xl font-bold text-gray-900 group-hover:text-purple-700 transition-colors duration-300">{pendingSignatures}</div>
            ...
            <div className="group relative overflow-hidden rounded-xl border border-gray-200 bg-gradient-to-br from-emerald-50 via-white to-emerald-50/30 p-4 transition-all duration-300 hover:shadow-lg hover:shadow-emerald-100/50 hover:border-emerald-200 hover:-translate-y-0.5">
              ...
              <div className="relative">
                ...
                <div className="text-2xl font-bold text-gray-900 group-hover:text-emerald-700 transition-colors duration-300">{completedItems}</div>
                <div className="text-xs text-gray-500 mt-1">Items</div>
              </div>
            </div>
          </div>
