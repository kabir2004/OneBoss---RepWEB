    ...
    <div className="space-y-8 bg-background min-h-screen pt-44 px-4 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center gap-4 mb-20 py-16 px-12 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-xl border border-purple-200 shadow-sm">
        ...
        <div>
          ...
          <p className="text-muted-foreground">Manage client households and family groups</p>
        </div>
      </div>

      {/* Statistics Overview - Compact Vercel-like Style */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="rounded-xl border border-border bg-gradient-to-br from-blue-50 via-background to-blue-50/30 dark:from-blue-950 dark:via-background dark:to-blue-950/30 p-4">
          ...
          <div className="text-2xl font-bold text-card-foreground">{totalHouseholds}</div>
          <div className="text-xs text-muted-foreground mt-1">Households</div>
        </div>

        <div className="rounded-xl border border-border bg-gradient-to-br from-emerald-50 via-background to-emerald-50/30 dark:from-emerald-950 dark:via-background dark:to-emerald-950/30 p-4">
          <div className="flex items-center gap-2 mb-2">
          ...
          <div className="text-2xl font-bold text-card-foreground">{activeHouseholds}</div>
          <div className="text-xs text-muted-foreground mt-1">Households</div>
        </div>

        <div className="rounded-xl border border-border bg-gradient-to-br from-purple-50 via-background to-purple-50/30 dark:from-purple-950 dark:via-background dark:to-purple-950/30 p-4">
          <div className="flex items-center gap-2 mb-2">
          ...
          <div className="text-2xl font-bold text-card-foreground">{formatCurrency(totalAssets)}</div>
      ...
      <div className={`grid gap-6 ${selectedHousehold ? 'grid-cols-1 lg:grid-cols-4' : 'grid-cols-1'}`}>
              ...
              <div className="mb-6">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className="pl-9 border-border focus:border-purple-300 focus:ring-purple-200 transition-all duration-200"
                  />
                </div>
                <div className="flex items-center gap-2 mt-3 p-3 bg-muted rounded-lg border border-border">
                  ...
                  <p className="text-xs text-muted-foreground">
                    <strong className="text-foreground">Section Search:</strong> Find households by name, ID, or primary client. Use sidebar for global client search.
                  </p>
                </div>
              </div>
                  ...
                  <TableBody>
                    {filteredHouseholds.map((household) => (
                      ...
                      >
                        ...
                        <TableCell className="font-medium text-card-foreground">{household.name}</TableCell>
                        ...
                        <TableCell>
                          <div className="flex gap-1">
                            <Button variant="ghost" size="sm" className="hover:bg-purple-100 dark:bg-purple-900 transition-colors">
        ...
        {selectedHousehold && (
          <div className="space-y-6">
            <Card className="border border-purple-200 shadow-sm bg-card">
              <CardHeader className="bg-gradient-to-r from-purple-50 to-purple-50/50 dark:from-purple-950 dark:to-purple-950/50 border-b border-purple-100 dark:border-purple-800">
                <CardTitle className="flex items-center gap-2">
                  <Home className="h-5 w-5 text-purple-600" />
                  Household Details
                </CardTitle>
                ...
                {(() => {
                  ...
                  return (
                    <div className="space-y-4">
                      <div className="group relative overflow-hidden rounded-xl border border-purple-200 bg-gradient-to-br from-purple-50 via-background to-purple-50/30 dark:from-purple-950 dark:via-background dark:to-purple-950/30 p-4 transition-all duration-300 hover:shadow-lg hover:shadow-purple-100/50">
                      ...
                      <div className="space-y-3">
                        <div>
                          <div className="text-sm text-muted-foreground mb-1">Primary Client</div>
                          <div className="font-medium text-card-foreground">{household.primaryClient}</div>
                        </div>
                        <div>
                          <div className="text-sm text-muted-foreground mb-2">Members ({household.members.length})</div>
                          <div className="space-y-1">
                            {household.members.map((member, index) => (
                              <div key={index} className="text-sm bg-muted px-3 py-2 rounded-lg border border-border hover:bg-accent transition-colors">
                                {member}
                              </div>
                            ))}
                          </div>
                      ...
                      <div className="grid grid-cols-1 gap-3">
                        <div className="group relative overflow-hidden rounded-lg border border-border bg-gradient-to-r from-gray-50 to-white p-3 transition-all duration-300 hover:shadow-md hover:border-gray-300">
                          ...
                          <div className="font-bold text-card-foreground text-lg group-hover:text-purple-700 transition-colors">{formatCurrency(household.totalAssets)}</div>
                        </div>
                        <div className="group relative overflow-hidden rounded-lg border border-border bg-gradient-to-r from-gray-50 to-white p-3 transition-all duration-300 hover:shadow-md hover:border-gray-300">
                          <div className="text-sm text-muted-foreground">Accounts</div>
                          <div className="font-bold text-card-foreground text-lg group-hover:text-purple-700 transition-colors">{household.accounts}</div>
                        </div>
                      </div>
